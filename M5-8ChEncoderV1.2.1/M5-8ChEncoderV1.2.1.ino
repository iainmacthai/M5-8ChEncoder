...
int current_val[8] = {0};  // added for version 1.2.1 for serial monitor ouput / other use
bool locked[8] = {false};  // added for version 1.2.1 for serial monitor ouput / other use
